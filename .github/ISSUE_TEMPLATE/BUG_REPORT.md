---
name: TensorProducts.jl bug report
about: Create a bug report to help us improve TensorProducts.jl
...
[YOUR OUTPUT HERE]
```
 - Output from `using Pkg; Pkg.status("TensorProducts")`:
```julia
julia> using Pkg; Pkg.status("TensorProducts")
[YOUR OUTPUT HERE]
```
